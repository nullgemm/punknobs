...
defines+=("-DPUNKNOBS_EXAMPLE_MACOS")
...
ninja_file=example_macos.ninja
...
libs+=("\$folder_library/macos/$name_lib""_$lib_suffix.a")
libs+=("\$folder_library/punknobs_macho_$lib_suffix.a")
...
{ \
echo "rule generator"; \
echo "    command = make/example/macos.sh $build $toolchain"; \
