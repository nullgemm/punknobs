...
folder_library="\$folder_punknobs/lib/punknobs/win"
...
#defines+=("-DPUNKNOBS_ERROR_HELPER_WIN")
defines+=("-DPUNKNOBS_ERROR_LOG_DEBUG")
defines+=("-DPUNKNOBS_COMPAT_WINE")
...
symbols_file="src/win/symbols_win.txt"
...
{ \
echo "# copy headers"; \
echo "build \$folder_include/punknobs_win.h: \$"; \
echo "cp src/include/punknobs_win.h"; \
echo ""; \
} >> "$output/$ninja_file"

{ \
echo "build headers: phony \$"; \
echo "\$folder_include/punknobs_win.h"; \
echo ""; \
} >> "$output/$ninja_file"
