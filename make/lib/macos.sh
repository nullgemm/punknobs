...
folder_library="\$folder_punknobs/lib/punknobs/macos"
...
flags+=("-Wno-gnu-empty-struct")
flags+=("-Isrc")
flags+=("-Isrc/include")
flags+=("-fPIC")
flags+=("-fdiagnostics-color=always")
flags+=("-I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/IOKit.framework/Headers/hid")
flags+=("-I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/ForceFeedback.framework/Headers")
...
ninja_file=lib_macos.ninja
src+=("src/macos/macos.m")
src+=("src/macos/macos_helpers.m")
...
{ \
echo "rule generator"; \
echo "    command = make/lib/macos.sh $build"; \
...
{ \
echo "# copy headers"; \
echo "build \$folder_include/punknobs_macos.h: \$"; \
echo "cp src/include/punknobs_macos.h"; \
echo ""; \
} >> "$output/$ninja_file"

{ \
echo "build headers: phony \$"; \
echo "\$folder_include/punknobs_macos.h"; \
echo ""; \
} >> "$output/$ninja_file"
